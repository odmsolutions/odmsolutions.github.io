...
Nearly every person is using some kind of email and yet it is still quite difficult to manage. In fact, many feel overwhelmed by a mountain of messages and can barely manage their mailbox.

In this lens I will discuss how to keep your inbox nice and slim, so you can see what really matters, how to set up automatic filters to label stuff up, and how to create quick actions to get it out of the way quickly.

I will discuss different clients and some problems with them, or cool features you can use with them to really get them to assist you in wading through a busy inbox. You need never fear a bulging mailbox again!

# Microsoft Outlook Tips 
## The common business desktop email client 

Microsoft Outlook is the main mail and calendar client in nearly every office workspace. I have been collecting small tips and tricks to make it work well for me - including things to keep it running smoothly, and stuff for GTD activities inside Outlook.
...
Deleting mail, if there are lots of things which are not mission critical or covering your own back, if you find things with large attachments or items from automated services and mailing lists, is the first best option. But it takes plenty of time, which not all of us have sometimes.
...
However, when you start deleting stuff - when the archive file gets too big (older outlook version have a size limit of around 2 Gb) or you just want to save a bit of disk space, you may notice that the files are not going down.
...
If you are interested in GTD, or just want ot keep a clean inbox, you will probably be constantly filing off email. Wouldn't it be handy to have some shortcut buttons. Note - this is different in Outlook 2010.
...
[Outlook 2010 Quick Reference Card](http://customguide.com/wp-content/themes/customguide/pdf/qr/outlook-quick-reference-2010.pdf)
...
One surefire way to do this is to use a gmail account to sync to.

* First setup a gmail account if you do not have one
* Then download and install the [Zindus](https://addons.mozilla.org/en-US/thunderbird/addon/6095) extension for Thunderbird.
