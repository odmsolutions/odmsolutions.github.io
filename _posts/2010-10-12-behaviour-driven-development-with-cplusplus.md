...
However, where CppSpec really shines is it is able to run/invoke a function, and expect exceptions, something missing from Igloo (unless I just haven't found it yet). CppSpec has more of an extensible matcher system compared with igloo.
